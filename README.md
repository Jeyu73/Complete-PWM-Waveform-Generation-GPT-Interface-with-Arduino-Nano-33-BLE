...
There are three components of this device: The user interface tooling, arduino firmware, and hardware integration.
 ...
 - Given base PWM code software, I modified 80% of the code to include adaptive Adaptive duty-cycle computation, Custom waveform table construction, Phase interpolation logic Amplitude-scaling and runtime parameter adjustment, Integration with the VS Code communication layer, and Acknowledgment (ACK) responses.
